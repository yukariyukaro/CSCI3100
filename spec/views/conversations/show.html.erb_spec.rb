...
RSpec.describe "conversations/show.html.erb", type: :view do
  let(:seller) { User.create!(name: "Seller", email: "seller_show_view@example.com", password: "password123") }
  let(:buyer)  { User.create!(name: "Buyer", email: "buyer_show_view@example.com", password: "password123") }
